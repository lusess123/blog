# 20250531 AI Researcher SHOCKING "Singularity in 2025 Prediction"（下）
+ [https://www.youtube.com/watch?v=U8m8TUREgBA](https://www.youtube.com/watch?v=U8m8TUREgBA)
+ 较早的模型，我们确实看到过一些它们安全性较低的例子，但也有一些例子表明它们可能更优秀、更有效。
+ 我们可能有人通过各种代理提交大量专利申请，涉及一些轰动的发明。
+ 另一个重要的理解点是，Alpha Evolve 被设计成一个通用的系统。
+ 我们必须有一种方法来判断输出的好坏，而且通常我们也会给模型提供初始程序和需要进化的组件。
+ 所以只要我们能评估某件事——只要目标明确，我们能说清楚我们要什么、怎样改进，那么这个系统就能尝试去实现
+ 如果全民基本收入足够充分，或者某种经济制度发生改变，达到不再稀缺的状态，大多数人能得到他们想要的东西，这肯定会大幅减少犯罪。
+ 事实上，我们的许多情绪感受并不直接来自外在环境，而更多源于大脑内部尚未完全了解的机制。

# 20250530 AI Researcher SHOCKING "Singularity in 2025 Prediction"（上）
+ [https://www.youtube.com/watch?v=U8m8TUREgBA](https://www.youtube.com/watch?v=U8m8TUREgBA)
+ 2023年**OpenAI**的时期，**Ilia Sutsker** 就曾说过，在发布AGI之前他们会需要一个地堡。
+ 根据**Alan Thompson**博士的说法，我们已经实现AGI的94%，马上将开始解锁ASI（超级人工智能）的各种能力。
+ 在基督教中，“rapture”（被提）指信徒在某个时刻消失，或有时描述为升往天堂。
+ 来自OpenAI的Greg Brockman说，GPT-3 Mini帮助布鲁克海文国家实验室的一位研究员找到了物理模型的新的精确解法。
+ 我们正朝向ASI迈进。他提出了一个包含50项指标的清单，目前还没有任何一项完全实现，但我们正朝着部分指标取得进展。
+ 这里提出的一种警告是，其中一个ASI模型通过各种代理机构，向世界各地的专利局大量提交了轰动性的发明，这些发明逐渐使其在所有技术领域占据主导地位。
